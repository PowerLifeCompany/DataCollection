...
//    if(![fileManager fileExistsAtPath:IPA_INFO_PATH]){
//        [fileManager copyItemAtPath:path toPath:IPA_INFO_PATH error:nil];
//    }
...
//        NSLog(@"进行1.0-->1.1升级的更新");
//        self.databaseVersion=VERSION_1_1;
//    }
//    if ([self.databaseVersion isEqualToString:VERSION_1_1]){
//        NSLog(@"进行1.1-->1.2升级的更新");
//        self.databaseVersion=VERSION_1_2;
//    }
    
    [SQLiteManager updateWithTableName:@"version_info" andClass:nil andParams:@{@"database_version":self.databaseVersion} andWhereParams:nil];
}
