...
//    _hudView.layer.shadowOpacity = 0.4f;
...
//            CGFloat c=arc4random()%255/255.0;
//            UIColor * color=[UIColor colorWithRed:a green:b blue:c alpha:1.0f];
//            [attString addAttributes:@{NSForegroundColorAttributeName:color} range:NSMakeRange(i, 1)];
//        }
//        self.stringLabel.attributedText = attString;
